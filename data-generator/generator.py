...
def get_cc(start_time='2022-05-08 21:08:10', end_time='2022-05-08 21:08:10'):
    ...
    battery_stream_name = "ndn--org--md2k--{}--{}--battery--phone".format(study_name,user_id)
    location_stream_name = "ndn--org--md2k--{}--{}--gps--phone".format(study_name,user_id)
    semantic_location_stream_name = "ndn--org--md2k--{}--{}--data_analysis--gps_episodes_and_semantic_location".format(study_name,user_id)
    accel_stream_name = "ndn--org--md2k--{}--{}--accelerometer--phone".format(study_name,user_id)
    gyro_stream_name = "ndn--org--md2k--{}--{}--gyroscope--phone".format(study_name,user_id)
